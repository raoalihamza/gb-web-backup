		...
		<DropdownMenu className="topbar__nav-dropdown-menu dropdown__menu">
			...
			<DropdownItem>
				<TopbarNavCategory title="E-commerce" icon="cart">
					...
					<TopbarNavLink
						title="Product Edit"
						route="/e-commerce/product_edit"
					/>
					<TopbarNavLink
						title="Product Page"
						route="/e-commerce/product_page"
					/>
					<TopbarNavLink
						title="Products List"
			...
			<DropdownItem>
				<TopbarNavCategory title="Default Pages" icon="file-empty">
					...
					<TopbarNavLink
						...
						route="/default_pages/invoice_template"
					/>
					<TopbarNavLink
						title="Pricing Cards"
						route="/default_pages/pricing_cards"
					/>
					<TopbarNavLink
					...
					<TopbarNavLink
						...
						route="/default_pages/search_results"
					/>
					<TopbarNavLink
						title="Text Editor"
			...
			<DropdownItem>
				<TopbarNavLink title="Log Out" icon="exit" route="/" />
			</DropdownItem>
		</DropdownMenu>
	</UncontrolledDropdown>
);
