...
const ProfileMain = ({ userData, t, setImageAsUrl }) => {
  ...
  const [organizationId, organizationData] = useAuth();
      ...
      <CardBox padding="0">
        <CardBody className="profile__card">
          ...
          <DeleteButton
            ...
            disabled={organizationData?.disabled}
            btnTitle={t("account.profile.delete_my_account")}
            dialogDescription={t("account.profile.delete_my_account_confirmation")}
            dialogTitle={t("account.profile.delete_my_account")}
            color="secondary"
            variant="outlined"
          />
        </CardBody>
