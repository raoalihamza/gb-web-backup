export const organizationRegistrationFields = (t, regionOpts) => [
  {
  ...
  },
  {
    ...
    label: t("account.profile.organisation_name"),
    type: "text",
    placeholder: t("account.profile.organisation_name"),
    defaultValue: "",
    tooltip: {
      exist: false,
      id: "",
  ...
  {
    name: "emailContact",
    label: t("account.profile.emailContact"),
    type: "text",
    placeholder: "example@mail.com",
    defaultValue: "",
    tooltip: {
      exist: true,
      id: "email-contact-note",
      description: t("register.email_contact_note"),
    },
    rules: {
      required: true,
    },
