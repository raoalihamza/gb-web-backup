...
function SessionCount({ t, sessionCount }) {
    return (
                ...
                <CardBody className="dashboard__card-widget">
                    <div className="mobile-app-widget">
                        <div className="mobile-app-widget__top-line mobile-app-widget__top-line--blue">
                            <p className="mobile-app-widget__total-stat">{sessionCount || 0}</p>
                            <TrendingDownIcon className="dashboard__trend-icon" />
                        </div>
                        <div className="mobile-app-widget__title">
                            <h5>{t('challenge.widget_sessions')}</h5>
                        </div>
                    </div>
                </CardBody>
            </Card>
...
export default withTranslation('common')(SessionCount);