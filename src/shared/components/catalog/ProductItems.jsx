					...
					{items.map((item, i) => (
						<div className="catalog-item" key={i}>
							<Link
								...
								to="/e-commerce/product_page"
							>
								{item.new ? (
									<img className="catalog-item__label" src={New} alt="new" />
								) : (
									''
								)}
								{item.sale ? (
									<img className="catalog-item__label" src={Sale} alt="sale" />
								) : (
									''
								)}
								...
								<div className="catalog-item__info">
									...
									{item.sale ? (
										<p className="catalog-item__old-price">${item.oldPrice}</p>
									) : (
										''
									)}
